# Setup Instructions for Micro-ROS on ESP32-S3 and ROS2 packages for the Mechanical Manipulator of Lakbay Rover

This repository contains the firmware and setup instructions for running **Micro-ROS** on an **ESP32-S3** and building the necessary ROS2 packagest o control the **6-DOF mechanical manipulator**.  
It enables the ESP32-S3 to communicate with a ROS 2 ecosystem using a **Micro-ROS Agent**, providing **real-time control, telemetry, and sensor integration**.
